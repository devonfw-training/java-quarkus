...
/**
 * Use-Case to add one or multiple {@link org.example.app.task.common.TaskItem task items} with a random activity that is generated by a locally running
 * Ollama.
 *
...
public class UcAddRandomActivityTaskItem {
  ...
  /**
   * Extracts ingredients from a given recipe and adds them as tasks to the specified {@link org.example.app.task.dataaccess.TaskListEntity}.
   *
   * @param taskListId the {@link org.example.app.task.dataaccess.TaskListEntity#getId() primary key} of the
