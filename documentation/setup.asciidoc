...
* If you use Windows, please download Windows MSI for IDEasy installation. Download and install IDEasy from https://github.com/devonfw/IDEasy/releases[here]. The Windows MSI file is not yet signed so you have to select `More info` (see bug https://github.com/devonfw/IDEasy/issues/1102[#1102]).
