...
We will learn how to run docker compose with postgres, our application and keycloak as well how to navigate inside a container.
...
* Run this command to see that the containers are up and running `docker-compose ps`
